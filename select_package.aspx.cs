...
public partial class select_package : System.Web.UI.Page
{
    ...
    public void pcode()
    {
        con = new SqlConnection("Data Source=.\\SQLEXPRESS;AttachDbFilename=C:\\Users\\Arslan\\Desktop\\JobPortalApplication\\App_Data\\JobportalDB.mdf;Integrated Security=True;User Instance=True");
        con.Open();
